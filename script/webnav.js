...
function LoadToolbar(parent, base)
{
    ...
    for (var index = 0; index < cmdcount; index++)
    {
            ...
            {
                    case "addtofavorites":
                            btn = CreateButton(td, "Add to favorites", "images/toolbar/addtofavorites.gif", "images/toolbar/addtofavoriteshot.gif", null, 22, 22, null);
                            btn.onclick = function() { DoAddToFavorites(); }
                            break;

                    case "togglenavigation":
                            btn = CreateButton(td, "Hide Navigation", "images/toolbar/togglenav.gif", "images/toolbar/togglenavhot.gif", null, 22, 22, null);
                            btn.onclick = function() { ToggleNavigationFrame(); }
                            break;

                    case "expandall":
                            btn = CreateButton(td, "Expand All", "images/toolbar/expand.gif", "images/toolbar/expandhot.gif", null, 22, 22, null);
                            btn.onclick = function() { alert("Not implemented"); }
                            break;

                    case "collapseall":
                            btn = CreateButton(td, "Collapse All", "images/toolbar/collapse.gif", "images/toolbar/collapsehot.gif", null, 22, 22, null);
                            btn.onclick = function() { alert("Not implemented"); }
                            break;

                    case "printtopic":
                            btn = CreateButton(td, "Print Topic", "images/toolbar/print.gif", "images/toolbar/printhot.gif", null, 22, 22, null);
                    ...
                    case "quicksearch":
                        ...
                        tr.appendChild(searchcell);
                            ...
                            btn = CreateButton(td, "Quick Search", "images/toolbar/search.gif", "images/toolbar/searchhot.gif", null, 22, 22, null);
                            btn.onclick = function() { QuickSearch(); }
                            break;

                    case "clearsearch":
                            btn = CreateButton(td, "Clear Search", "images/toolbar/resetsearch.gif", "images/toolbar/resetsearchhot.gif", null, 22, 22, null);
                            btn.onclick = function() { ResetQuickSearch(); }
                            break;

                    case "back":
                            btn = CreateButton(td, "Back", "images/toolbar/navback.gif", "images/toolbar/navbackhot.gif", null, 22, 22, null);
                            btn.onclick = function() { history.back(); }
                            break;

                    case "forward":
                            btn = CreateButton(td, "Forward", "images/toolbar/navforward.gif", "images/toolbar/navforwardhot.gif", null, 22, 22, null);
                            btn.onclick = function() { history.forward(); }
                            break;

                    case "stop":
                            btn = CreateButton(td, "Stop", "images/toolbar/navstop.gif", "images/toolbar/navstophot.gif", null, 22, 22, null);
                            btn.onclick = function() { SetContentDocument(defaultTopic); }
                            break;

                    case "refresh":
                            btn = CreateButton(td, "Refresh", "images/toolbar/navrefresh.gif", "images/toolbar/navrefreshhot.gif", null, 22, 22, null);
                            btn.onclick = function() { RefreshContentDocument(); }
                            break;

                    case "home":
                            btn = CreateButton(td, "Home", "images/toolbar/navhome.gif", "images/toolbar/navhomehot.gif", null, 22, 22, null);
                            btn.onclick = function() { SetContentDocument(defaultTopic); }
                            break;

                    case "gotoc":
                            btn = CreateButton(td, "Table of Contents", "images/toolbar/toc.gif", "images/toolbar/tochot.gif", null, 22, 22, null);
                            btn.onclick = function() { GlobalSetActiveNavTab("toc"); }
                            break;

                    case "goindex":
                            btn = CreateButton(td, "Index", "images/toolbar/index.gif", "images/toolbar/indexhot.gif", null, 22, 22, null);
                            btn.onclick = function() { GlobalSetActiveNavTab("index"); }
                            break;

                    case "gosearch":
                            btn = CreateButton(td, "Search", "images/toolbar/search.gif", "images/toolbar/searchhot.gif", null, 22, 22, null);
                            btn.onclick = function() { GlobalSetActiveNavTab("search"); }
                            break;

                    case "goglossary":
                            btn = CreateButton(td, "Glossary", "images/toolbar/glossary.gif", "images/toolbar/glossaryhot.gif", null, 22, 22, null);
                            btn.onclick = function() { GlobalSetActiveNavTab("glossary"); }
                            break;

                    case "gofavorites":
                            btn = CreateButton(td, "Favorites", "images/toolbar/favorites.gif", "images/toolbar/favoriteshot.gif", null, 22, 22, null);
